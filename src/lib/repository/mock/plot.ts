...
const SEED_PLOTS: PlotSeed[] = [
  ...
  },
  {
    ...
    DeforestationRiskStatus: 'Thấp', ActualQuantityDelivered: 73.3,
  ...
  // ── NMXH plots ──────────────────────────────────────────────────────────────
  {
    ...
    DeforestationRiskStatus: 'Thấp', ActualQuantityDelivered: 22.8,
  ...
  },
  {
    ...
    DeforestationRiskStatus: 'Trung bình', ActualQuantityDelivered: 8.4,
  ...
  // ── NMCT plots ──────────────────────────────────────────────────────────────
  {
    ...
    DeforestationRiskStatus: 'Thấp', ActualQuantityDelivered: 31.6,
